...
def call_visa_roadmap_api(text):
    ...
    """
    url = "https://visaroadmap-main-82730143568.us-central1.run.app/generate_roadmap"
...
def convert_dict_to_markdown(data):
    ...
    # Add Title
    markdown_content.append("# Solution Architect\n")
...
st.set_page_config(page_title="Solution Architect", layout="wide")
st.title("Solution Architect")
    ...
    if st.button("Generate"):
        with st.spinner("Processing..."):
            ...
            if result:
                ...
                st.subheader("Your Visa Roadmap")
